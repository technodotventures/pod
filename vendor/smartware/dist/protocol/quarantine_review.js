...
export async function handleQuarantineReview(params, evidenceDir, layer0, store, config) {
    ...
    if (current !== 'quarantined') {
        throw new ProtocolError('invalid_state', `Observation '${params.target_obs_id}' is in state '${current}', not 'quarantined'`);
    }
...
//# sourceMappingURL=quarantine_review.js.map