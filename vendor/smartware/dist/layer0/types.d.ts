...
export type ObservationType = 'message' | 'file' | 'meeting' | 'preference' | 'decision' | 'tool_output' | 'claim_extracted' | 'correction' | 'tombstone' | 'redaction' | 'compaction' | 'feedback' | 'consent_change' | 'quarantine_review' | 'system' | 'agent_run_started' | 'agent_run_completed' | 'agent_action_proposed' | 'agent_action_approved' | 'agent_action_rejected' | 'workflow_run_started' | 'workflow_run_completed' | 'task_created' | 'task_completed' | 'meeting_brief_created' | 'followup_drafted';
...
export declare const TERMINAL_STATES: Set<EffectiveStatus>;
export declare const TRANSITIONS: Record<string, Record<string, EffectiveStatus>>;
