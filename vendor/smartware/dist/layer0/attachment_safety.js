...
export function checkAttachmentSafety(filename, sizeBytes) {
...
export function isTextExtractable(mimeType) {
    ...
    if (mimeType === 'application/pdf')
        return true;
    if (mimeType.includes('openxmlformats') || mimeType.includes('opendocument'))
        return true;
    if (mimeType === 'application/rtf')
        return true;
    return false;
}
//# sourceMappingURL=attachment_safety.js.map