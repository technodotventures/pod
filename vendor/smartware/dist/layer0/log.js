...
function dateToPath(evidenceDir, date) {
 ...
 */
export function appendObservation(evidenceDir, obs) {
 ...
 */
export function readFile(evidenceDir, date) {
 ...
 */
export function* readAll(evidenceDir) {
 ...
 */
export function listDates(evidenceDir) {
    if (!existsSync(evidenceDir))
        return [];
